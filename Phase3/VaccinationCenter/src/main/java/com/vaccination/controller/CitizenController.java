...
public class CitizenController {
	...
	public String addCitizen(Model model) {
		...
		return "add-citizen.html";
	}
	
	@PostMapping("/add")
	public String processAddCitizenForm(@ModelAttribute("citizen") Citizen citizen, @RequestParam("vaccineCenterId") Long vaccineCenterId) {
	...
	@PostMapping("/{id}/edit")
	public String updateCitizen(@PathVariable("id") Long id, @ModelAttribute("citizen") Citizen updatedCitizen, @RequestParam("vaccineCenterId") Long vaccineCenterId) { 
		VaccineCenter vaccineCenter = vaccineCenterService.getVaccineCenterById(vaccineCenterId); 
		Citizen citizen = citizenService.getCitizenById(id);
