...
<%@ page import="com.RailwayCrossingsDAO"%>
...
<body>
	...
	<button onclick="location.href='userFavouriteCrossing.jsp'"
	...
	<div class="container">
		...
		<form action="addToFavorites" method="post" style="display: inline;">
			...
			<button type="submit" style="border-radius: 10px; font-weight: bold; margin-top: 10px; margin-left: 0px;">
